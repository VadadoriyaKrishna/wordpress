# LSTM model building and testing
...
X_val, X_test, Y_val, Y_test = train_test_split(X_temp, Y_temp, test_size=0.5, random_state=42)    # data splitting         uncomment this
...
model1 = Sequential()                                                                                        #uncomment this and this use for model trainning
...
def GetPredictionByModel(MAIL):
  saved_model = load_model("Email_Bifuraction_model.h5")                                                 #above multiline comment code commented then this will be uncomment
...
# print(GetPredictionByModel(text_test))           #debugging tool comment this when issue then uncomment